...
class BayesianOptimization:
    ...
    This class is straight fire for finding optimal points in ur function space.
    Get rdy to minimize/maximize like a pr0! Woot!
    """
    ...
    def __init__(self, f, X_init, Y_init, bounds, ac_samples, l=1, 
        ...
        self.X_s = np.linspace(min_bound, max_bound, ac_samples
                              ).reshape(-1, 1)
